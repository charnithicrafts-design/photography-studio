...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    :root {
      --bg-light: var(--wp--preset--color--thalam-bg-light, #F4F1EA);
      --grid-dark: var(--wp--preset--color--thalam-grid-dark, #0A369D);
      --mid-grey: var(--wp--preset--color--thalam-muted, #8892B0);
      --light-grey: #DDDBD7; --rule: 1px solid var(--grid-dark); --rule-light: 1px solid rgba(10,54,157,0.2);
      --accent: var(--wp--preset--color--thalam-accent-bold, #FF5722);
    ...
    body { background: var(--bg-light); color: var(--grid-dark); font-family: var(--font-mono); -webkit-font-smoothing: antialiased; overflow-x: hidden; }
    ...
    .nav-logo { text-align: center; font-weight: 700; font-size: 1rem; letter-spacing: 0.06em; text-transform: uppercase; text-decoration: none; color: var(--grid-dark); }
    ...
    .nav-book a:hover { background: var(--grid-dark); }
    ...
    .btn-primary:hover { background: var(--grid-dark); }
    .btn-ghost { display: inline-flex; align-items: center; justify-content: space-between; border: var(--rule-light); color: var(--grid-dark); font-family: var(--font-mono); font-size: 0.8rem; letter-spacing: 0.1em; text-transform: uppercase; text-decoration: none; padding: 1.1rem 1.75rem; transition: all 0.2s; }
    .btn-ghost:hover { border-color: var(--grid-dark); background: rgba(255,255,255,0.04); }
    ...
    .status-text strong { color: var(--grid-dark); }
    ...
    .service-price-val { font-weight: 700; font-size: 1.3rem; letter-spacing: -0.02em; color: var(--grid-dark); }
    .service-cta { display: flex; align-items: center; justify-content: space-between; background: transparent; border: var(--rule-light); color: var(--grid-dark); font-family: var(--font-mono); font-size: 0.72rem; letter-spacing: 0.1em; text-transform: uppercase; text-decoration: none; padding: 0.9rem 1rem; transition: all 0.2s; }
    ...
    .kpi-val { font-weight: 700; font-size: 3rem; letter-spacing: -0.06em; line-height: 1; color: var(--grid-dark); }
    ...
    .form-input, .form-select { width: 100%; background: transparent; border: none; border-bottom: var(--rule-light); color: var(--grid-dark); font-family: var(--font-mono); font-size: 0.9rem; padding: 0.75rem 0; outline: none; transition: border-color 0.2s; appearance: none; }
    .form-input:focus, .form-select:focus { border-color: var(--accent); }
    .form-select option { background: #111; color: var(--grid-dark); }
    ...
    .form-submit:hover { background: var(--grid-dark); }
    ...
    .footer-col a:hover { color: var(--grid-dark); }
...
<body>
  ...
  <footer>
    ...
    <div class="footer-col" style="border-right:none;">
      ...
      <a href="<?php echo home_url('/'); ?>" style="color:var(--grid-dark);font-weight:700;">Chitramaya Creatives ↗</a>
